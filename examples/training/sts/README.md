...
```python
from sentence_transformers_old import SentenceTransformer, SentencesDataset, InputExample, losses
...
![SBERT Siamese Network Architecture](https://raw.githubusercontent.com/UKPLab/sentence-transformers-old/master/docs/img/SBERT_Siamese_Network.png "SBERT Siamese Architecture")
